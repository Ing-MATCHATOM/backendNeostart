                    ...
                    <tr>
                        <td style="padding:30px; color:#1f2937;">
                            <p style="font-size:16px; margin-bottom:20px;">
                                Bonjour <strong>{{ $temoin->prenom ?? $temoin->nom_famille }}</strong>,
                            </p>

                            <p style="font-size:15px; margin-bottom:20px;">
                                Un compte temoin vous a été créé par le parent <strong>{{ $user->prenom_nom ?? $user->nom_famille }}</strong> sur <strong>EduManager</strong>.  
                                Grâce à ce compte, vous pourrer confirmer les présences des enseignants lors des répétitions.
                            </p>
