                    ...
                    <tr>
                        <td style="padding:30px; color:#1f2937;">
                            <p style="font-size:16px; margin-bottom:20px;">
                                Bonjour <strong>{{ $eleve->prenom ?? $eleve->nom_famille }}</strong>,
                            </p>

                            <p style="font-size:15px; margin-bottom:20px;">
                                Un compte eleve vous a été créé par le parent <strong>{{ $user->prenom_nom ?? $user->nom_famille }}</strong> sur <strong>EduManager</strong>.  
                                Grâce à ce compte, vous serez en contact avec lui sur l'évolution de vos cours de répétitions.
                            </p>
